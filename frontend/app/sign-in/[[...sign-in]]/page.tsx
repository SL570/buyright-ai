      ...
      <div style={{ width: "100%", maxWidth: 380, textAlign: "center" }}>
        ...
        <div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.09)", borderRadius: 16, padding: "32px 28px", display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <button
            ...
            disabled={!!loading}
            style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.12)", borderRadius: 10, padding: "13px 20px", color: "#F1F5F9", fontSize: 14, fontWeight: 600, cursor: loading ? "not-allowed" : "pointer", fontFamily: "system-ui", opacity: loading === "google" ? 0.7 : 1, width: "100%" }}
          >
